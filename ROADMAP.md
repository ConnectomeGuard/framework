...
| **Conf.** | Connectome-construction algorithm for cross-site reproducibility (Phase-2 sub-result) | ✅ complete | 🟡 under submission | ⬜ withheld pending review |
...
- A focused methodological result from the Phase-2 algorithms line, prepared as a conference paper and currently under submission.
- Evaluated on the same ABIDE-II cohort as the framework (N = 229, 5 sites).
- **Research:** complete · **Publication:** under submission · **Open source:** method details and code **withheld pending review**; the repository will be linked on acceptance.
